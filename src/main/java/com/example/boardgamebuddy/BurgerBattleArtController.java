...
public class BurgerBattleArtController {
    ...
    public BurgerBattleArtController(
            BoardGameService boardGameService, ImageService imageService) {
    ...
    @GetMapping(path = "/burgerBattleArtImage", produces = "image/png")
    ...
    private String getImageInstructions(String burger) {
        ...
        var question = new Question("Burger Battle", "What ingredients are on the " + burger + " burger?");
        var answer = boardGameService.askQuestion(question, "art_conversation");
